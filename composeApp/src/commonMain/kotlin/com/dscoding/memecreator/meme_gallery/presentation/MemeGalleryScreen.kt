...
package com.dscoding.memecreator.meme_gallery.presentation
...
import memecreator.composeapp.generated.resources.meme_templates
...
fun MemeGalleryScreen(
    ...
    Scaffold(
        ...
        LazyVerticalStaggeredGrid(
            ...
            items(items = memeTemplates, key = { it.id }
            ) { memeTemplate ->
                Card(
